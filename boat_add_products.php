...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
        $stmt = $conn->prepare("INSERT INTO boat_products (name, description, price, mrp, image, brand) VALUES (?, ?, ?, ?, ?, ?)");
...
<div class="container d-flex justify-content-center align-items-start pt-5 pb-5">
  ...
  <h3 class="text-center mb-4 form-label">Add <?= htmlspecialchars($navbarLabels['boat'] ?? 'boAt'); ?> Product</h3>
    <?php echo $message; ?>
    <form method="POST" enctype="multipart/form-data">
      ...
      <div class="d-grid gap-3 mt-3">
        ...
        <a href="boat.php" class="btn btn-secondary">← Back to boAt Page</a>
      </div>
    </form>
  </div>
</div>
