  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse show">
      ...
      <ul class="navbar-nav me-auto">
        <li class="nav-item">
          <a href="<?php echo $delete_mode ? 'index.php?delete_mode=1' : 'login.php'; ?>" class="nav-link nav-glow" >Home</a>
        </li>
        <?php if (($_SESSION['role'] ?? '') === 'admin'): ?>
          <li class="nav-item"><a class="nav-link nav-glow" href="login.php">Admin</a></li>
         <?php endif; ?>
        <li class="nav-item">
          <a class="nav-link nav-glow" href="login.php">Contact</a>
        </li>
    ...
    <button type="submit">
      ...
      <div class="d-flex align-items-center">
        ...
        <!-- Complain -->
        <a class="nav-link nav-glow me-2" href="login.php">
          📮 Complain List
        </a>
        ...
        <!-- Cart -->
        <a class="nav-link nav-glow" href="login.php">
...
<nav class="navbar bg-info d-flex d-lg-none px-3">
  ...
  <ul class="dropdown-menu dropdown-glass">
    <li><a href="<?php echo $delete_mode ? 'index.php?delete_mode=1' : 'login.php'; ?>" class="dropdown-item nav-glow" >Home</a></li>
    <?php if (($_SESSION['role'] ?? '') === 'admin'): ?>
         <li><a class="dropdown-item nav-glow" href="login.php">Admin</a></li>
         <?php endif; ?>
    <li><a class="dropdown-item nav-glow" href="login.php">Contact</a></li>
    <?php if (isset($_SESSION['user_id'])): ?>
    ...
    <li><a class="dropdown-item nav-glow" href="ragister.php">Register</a></li>
     <?php endif; ?>
    <li><a class="dropdown-item nav-glow" href="login.php">Complain List</a></li>
    <li><a class="dropdown-item nav-glow" href="login.php">Orders</a></li>
  ...
  <div class="container-fluid justify-content-center">
    ...
    <!-- Profile (ONLY ONE ICON) -->
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-glass">
          <?php if (isset($_SESSION['user_id'])): ?>
            <li><a class="dropdown-item nav-glow" href="login.php">My Profile</a></li>
            <li><a class="dropdown-item nav-glow" href="login.php">My Orders</a></li>
            <li><a class="dropdown-item nav-glow" href="login.php">My Complaints</a></li>
        ...
        <a href="javascript:void(0);" 
           ...
           style="color:red; font-weight:bold;">Less</a>
                        ...
                        <h6>
                         ...
                         <?php if (!$delete_mode): ?>
  <a href="home.php?add_to_cart=<?php echo (int)$row['id']; ?>" 
   class="btn btn-info btn-hover">
   Add to Cart
</a>

<a href="home.php?add_to_cart=<?php echo (int)$row['id']; ?>&buy_now=1" 
