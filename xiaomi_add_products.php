...
<div class="container d-flex justify-content-center align-items-start pt-5 pb-5">
  ...
  <h3 class="text-center mb-4 form-label">Add <?= htmlspecialchars($navbarLabels['xiaomi'] ?? 'Xiaomi'); ?> Product</h3>
    <?php echo $message; ?>
    <form method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="number" name="price" class="form-control" step="0.01" placeholder="Enter selling price..." required>
      </div>

      <div class="mb-3">
        <label class="form-label">MRP (₹)</label>
        <input type="number" name="mrp" class="form-control" step="0.01" placeholder="Enter MRP..." required>
      </div>
