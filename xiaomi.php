    ...
    <?php endif; ?>
      ...
      <li class="nav-item dropdown mx-3">
        ...
        <ul class="dropdown-menu dropdown-glass">
          ...
          <li><a class="dropdown-item nav-glow" href="<?php echo $delete_mode ? 'oneplusbud.php?delete_mode=1' : 'oneplusbud  .php'; ?>"><?= htmlspecialchars($navbarLabels['oneplus_buds'] ?? 'OnePlus Buds'); ?></a></li>
