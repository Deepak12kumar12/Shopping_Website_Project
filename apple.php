  ...
  <ul class="dropdown-menu dropdown-glass">
    ...
    <?php endif; ?>
      ...
      <li class="nav-item dropdown mx-3">
        ...
        <ul class="dropdown-menu dropdown-glass">
          <li><a href="<?php echo $delete_mode ? 'hp.php?delete_mode=1' : 'hp.php'; ?>" class="dropdown-item nav-glow" ><?= htmlspecialchars($navbarLabels['hp'] ?? 'HP'); ?></a></li>
          <li><a href="<?php echo $delete_mode ? 'dell.php?delete_mode=1' : 'dell.php'; ?>" class="dropdown-item nav-glow" ><?= htmlspecialchars($navbarLabels['dell'] ?? 'Dell'); ?></a></li>
          <li><a href="<?php echo $delete_mode ? 'macbook.php?delete_mode=1' : 'macbook.php'; ?>" class="dropdown-item nav-glow" ><?= htmlspecialchars($navbarLabels['macbook'] ?? 'MacBook'); ?></a></li>
      ...
      <li class="nav-item dropdown mx-3">
        ...
        <ul class="dropdown-menu dropdown-glass">
          <li><a href="<?php echo $delete_mode ? 'boat.php?delete_mode=1' : 'boat.php'; ?>" class="dropdown-item nav-glow" ><?= htmlspecialchars($navbarLabels['boat'] ?? 'boAT'); ?></a></li>
          <li><a href="<?php echo $delete_mode ? 'oneplusbud.php?delete_mode=1' : 'oneplusbud.php'; ?>" class="dropdown-item nav-glow" ><?= htmlspecialchars($navbarLabels['oneplusbud'] ?? 'OnePlus'); ?></a></li>
          <li><a href="<?php echo $delete_mode ? 'boult.php?delete_mode=1' : 'boult.php'; ?>" class="dropdown-item nav-glow" ><?= htmlspecialchars($navbarLabels['boult'] ?? 'Boult'); ?></a></li>
